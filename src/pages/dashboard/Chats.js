...
import { Avatar, Badge, Box, Button, Divider, IconButton, InputBase, Stack, Typography, alpha, useTheme } from '@mui/material'
...
const ChatElements = ({ id, name, img, msg, time, unread, online }) => {
    ...
    return (
        <Box sx={{ position: 'relative', width: 320, backgroundColor: theme.palette.mode === 'light' ? "#F8FAFF" : theme.palette.background.paper, boxShadow: "0px 0px 2px rgba(0,0,0,0.25)" }}>
            <Stack p={3} spacing={2} sx={{ height: "100vh" }}>
                ...
                <Stack spacing={2.4} direction='column' sx={{ flexGrow: 1, overflowY: 'scroll', height: '100%' }}>
